...
|---|---|---|
| Paid inference for lab multi-model runs | **Pollinations** (anonymous, live) — run DNA harness across framings today at $0 | A *third* model family still wants a key; Hetzner free inference (EU, 500M tok/day) is one free signup away — not yet verified, see DROPPED.md |
